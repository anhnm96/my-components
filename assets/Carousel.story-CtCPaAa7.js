import { aD as defineComponent, aZ as inject, at as ref, aT as onMounted, as as _export_sfc, aw as openBlock, aH as createElementBlock, az as renderSlot, a_ as provide, a$ as useIntervalFn, b0 as onBeforeUnmount, av as computed, aG as createBaseVNode, aB as normalizeClass, aF as createVNode, ay as withCtx, aJ as Fragment, aI as renderList, b1 as Transition, aS as withModifiers, aK as createCommentVNode, aA as normalizeStyle, aM as pushScopeId, aN as popScopeId, aE as resolveComponent, ax as createBlock, aO as createTextVNode, aL as toDisplayString } from "./vendor-BdBYoA5y.js";
import { _ as __nuxt_component_1 } from "./VMotion-6cY7kzDE.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, dragging, activeIndex, elRef, startX, slideX, delta, itemWidth, items, addItem, eventMoveType, eventEndType, get startPosition() {
...
const _hoisted_11 = { class: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-xl font-bold text-red-500" };
  ...
  return openBlock(), createBlock(_component_Story, { title: "Carousel" }, {
    default: withCtx(() => [
      ...
      createVNode(_component_Variant, { title: "list" }, {
        default: withCtx(() => [
          createVNode($setup["Carousel"], { "items-class": "mt-3 -mx-3 overflow-x-auto w-full flex" }, {
