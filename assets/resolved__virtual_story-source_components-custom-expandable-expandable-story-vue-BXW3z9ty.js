const resolved__virtual_storySource_componentsCustomExpandableExpandableStoryVue = `<script lang="ts" setup>
...
`;
export {
  resolved__virtual_storySource_componentsCustomExpandableExpandableStoryVue as default
};
