...
const _hoisted_11 = /* @__PURE__ */ createBaseVNode(
  ...
  { class: "relative" },
  [
    /* @__PURE__ */ createBaseVNode("div", { class: "relative py-20" }, [
      /* @__PURE__ */ createBaseVNode("div", { class: "absolute inset-0 flex items-center justify-center [mask-image:linear-gradient(to_bottom,white,transparent)]" }, [
        /* @__PURE__ */ createBaseVNode("div", { class: "bg-white/2.5 absolute h-96 w-96 rounded-full shadow-xl" }),
        /* @__PURE__ */ createBaseVNode("div", { class: "bg-white/2.5 absolute h-[19rem] w-[19rem] rounded-full border border-white/5 shadow-xl" }),
        /* @__PURE__ */ createBaseVNode("div", { class: "bg-white/2.5 absolute h-56 w-56 rounded-full border border-white/10 shadow-xl" }),
        /* @__PURE__ */ createBaseVNode("div", { class: "bg-white/2.5 absolute h-36 w-36 rounded-full border border-dashed border-white/15 shadow-xl" })
      ]),
      /* @__PURE__ */ createBaseVNode("div", { class: "relative flex items-center justify-center" }, [
        /* @__PURE__ */ createBaseVNode("div", { class: "flex h-16 w-16 rounded-full border border-white/25 bg-white/5 p-3 shadow-xl" }, [
    ...
    /* @__PURE__ */ createCommentVNode(" description "),
    /* @__PURE__ */ createBaseVNode("div", { class: "mt-6 px-8 pb-8" }, [
      /* @__PURE__ */ createBaseVNode("div", { class: "text-lg text-white" }, "Secure authentication"),
      /* @__PURE__ */ createBaseVNode("p", { class: "mt-2 text-sm font-light leading-relaxed text-white/75" }, " Unlock the future with Touch ID. Fast, secure, and uniquely yours, unless someone takes a copy of your finger. ")
    ])
  ],
  -1
  /* HOISTED */
