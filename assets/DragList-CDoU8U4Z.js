import { aD as defineComponent, bw as useSlots, at as ref, b6 as reactive, av as computed, aU as throttle, as as _export_sfc, aw as openBlock, ax as createBlock, ay as withCtx, aG as createBaseVNode, aK as createCommentVNode, aH as createElementBlock, aJ as Fragment, aI as renderList, b9 as createSlots, az as renderSlot, aQ as mergeProps, aR as withModifiers, bx as TransitionGroup } from "./vendor-CMJc4gfg.js";
import { D as DnDState, V as VDragDrop, a as DragListState } from "./DragItem-YWJ5mh2G.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const dragstart = (e) => {
      var _a, _b;
      if (!((_a = e.target) == null ? void 0 : _a.draggable)) return;
          ...
          return openBlock(), createBlock($setup["DragItem"], {
            ...
            renderList(Object.keys(_ctx.$slots), (name) => {
              return {
                name,
                fn: withCtx((scope) => [
                  renderSlot(_ctx.$slots, name, mergeProps({ ref_for: true }, scope, {
                    item,
                    index
                  }), void 0, true)
                ])
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-b47a31d9"], ["__file", "D:/projects/my-components/components/custom/drag/DragList.vue"]]);
export {
