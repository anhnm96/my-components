import { b6 as reactive, aD as defineComponent, bw as useSlots, at as ref, aS as onMounted, a$ as onBeforeUnmount, av as computed, aU as throttle, as as _export_sfc, b1 as nextTick, aw as openBlock, ax as createBlock, ay as withCtx, aK as createCommentVNode, az as renderSlot, aH as createElementBlock, aB as normalizeClass, aR as withModifiers, aC as resolveDynamicComponent } from "./vendor-CMJc4gfg.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const clazz = computed(() => {
      ...
      if (dataAllowed.value === void 0) return null;
      return {
    ...
    function dragenter(e) {
      ...
      if (props.droppable) (_b = el.value) == null ? void 0 : _b.classList.add(props.hoverClass);
    }
    function dragleave() {
      var _a;
      if (props.droppable) {
