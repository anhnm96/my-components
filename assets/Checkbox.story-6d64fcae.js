import { u as useInternalValue } from "./index-1b5662ed.js";
import { aB as defineComponent, aC as ref, au as openBlock, aA as createElementBlock, aJ as withDirectives, aK as vModelCheckbox, aw as createBaseVNode, aL as mergeProps, aD as renderSlot, aF as createCommentVNode, aH as normalizeClass, aM as withModifiers, aN as computed, aO as onMounted, aP as watch, aQ as Motion, aR as spring, av as createVNode, aS as normalizeStyle, ay as pushScopeId, az as popScopeId, ar as resolveComponent, as as createBlock, at as withCtx, ax as createTextVNode, aE as toDisplayString, aT as renderList, aU as Fragment } from "./vendor-c237071b.js";
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("label", {
    ...
    _ctx.$slots.default ? (openBlock(), createElementBlock("span", _hoisted_2$2, [
      renderSlot(_ctx.$slots, "default")
    ])) : createCommentVNode("v-if", true)
  ], 10, _hoisted_1$2);
}
_sfc_main$2.__file = "components/base/checkbox/Checkbox.vue";
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__file", "C:/Users/anhnm21/Desktop/ma/my-components/components/base/checkbox/Checkbox.vue"]]);
const CheckboxMotion_vue_vue_type_style_index_0_scoped_db1be4f5_lang = "";
const __default__ = {
  inheritAttrs: false
};
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const __returned__ = { props, emit, value, inputRef, focus, _value, isIndeterminated, draw, get Motion() {
      return Motion;
    }, get spring() {
      return spring;
    } };
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("label", {
    ...
    createBaseVNode(
      ...
      [
        $setup._value ? (openBlock(), createElementBlock("svg", _hoisted_2$1, [
          createVNode($setup["Motion"], {
            tag: "path",
            initial: { strokeDasharray: 1, strokeDashoffset: 1 },
            animate: $setup.draw(1),
            transition: {
              delay: 0.2,
              easing: $setup.spring({
                stiffness: 400,
            ...
            "stroke-linejoin": "round",
            d: "M5 13l4 4L19 7"
          }, null, 8, ["animate", "transition"])
        ])) : createCommentVNode("v-if", true),
        $setup.isIndeterminated ? (openBlock(), createElementBlock("svg", _hoisted_3$1, _hoisted_5$1)) : createCommentVNode("v-if", true)
      ],
      4
      /* STYLE */
    ),
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-db1be4f5"], ["__file", "C:/Users/anhnm21/Desktop/ma/my-components/components/base/checkbox/CheckboxMotion.vue"]]);
