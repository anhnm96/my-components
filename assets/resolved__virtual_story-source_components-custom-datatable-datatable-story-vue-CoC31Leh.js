const resolved__virtual_storySource_componentsCustomDatatableDatatableStoryVue = `<script>
...
`;
export {
  resolved__virtual_storySource_componentsCustomDatatableDatatableStoryVue as default
};
