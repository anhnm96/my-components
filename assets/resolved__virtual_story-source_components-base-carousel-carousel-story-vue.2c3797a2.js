const resolved__virtual_storySource_componentsBaseCarouselCarouselStoryVue = `<script lang="ts" setup>
...
`;
export {
  resolved__virtual_storySource_componentsBaseCarouselCarouselStoryVue as default
};
