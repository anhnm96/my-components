import { as as _export_sfc, aw as openBlock, aH as createElementBlock, az as renderSlot, aG as createBaseVNode, aO as withDirectives, bf as vShow, aB as normalizeClass, aR as withModifiers, aD as defineComponent, at as ref, aE as resolveComponent, ax as createBlock, ay as withCtx, aF as createVNode, aI as renderList, aJ as Fragment, aL as toDisplayString } from "./vendor-CMJc4gfg.js";
const _sfc_main$1 = {
  props: {
    files: {
      type: Array,
              ...
              renderList($setup.files, (file, index) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  file.type.includes("image") ? (openBlock(), createElementBlock("img", {
                    ...
                    src: file.url,
                    alt: file.name
                  }, null, 8, _hoisted_2)) : (openBlock(), createElementBlock("svg", _hoisted_3, [..._cache[1] || (_cache[1] = [
                    createBaseVNode(
                      "path",
                      {
