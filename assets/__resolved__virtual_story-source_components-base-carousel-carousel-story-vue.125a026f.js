const __resolved__virtual_storySource_componentsBaseCarouselCarouselStoryVue = `<script lang="ts" setup>
...
`;
export {
  __resolved__virtual_storySource_componentsBaseCarouselCarouselStoryVue as default
};
