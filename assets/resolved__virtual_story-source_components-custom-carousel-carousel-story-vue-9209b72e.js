const resolved__virtual_storySource_componentsCustomCarouselCarouselStoryVue = `<script lang="ts" setup>
...
`;
export {
  resolved__virtual_storySource_componentsCustomCarouselCarouselStoryVue as default
};
