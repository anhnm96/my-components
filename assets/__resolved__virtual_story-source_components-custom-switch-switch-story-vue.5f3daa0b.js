const __resolved__virtual_storySource_componentsCustomSwitchSwitchStoryVue = `<script lang="ts" setup>
...
`;
export {
  __resolved__virtual_storySource_componentsCustomSwitchSwitchStoryVue as default
};
