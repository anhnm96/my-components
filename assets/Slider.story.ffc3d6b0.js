import { u as useInternalValue } from "./index.73fd1b77.js";
import { az as defineComponent, aM as computed, aC as ref, aX as throttle, aY as Motion, aZ as clamp, au as openBlock, aB as createElementBlock, aD as renderSlot, av as createVNode, at as withCtx, ay as createBaseVNode, a_ as normalizeStyle, a$ as withModifiers, ar as resolveComponent, as as createBlock, aF as createCommentVNode, aE as toDisplayString } from "./vendor.a79b1064.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    function setProgress(e) {
      var _a;
      (_a = startPoint.value) != null ? _a : startPoint.value = e.clientX;
...
const _hoisted_1$1 = /* @__PURE__ */ createBaseVNode("div", { class: "h-full w-full bg-white/20" }, null, -1);
...
const _hoisted_3 = /* @__PURE__ */ createBaseVNode("p", { class: "text-center text-sm font-medium text-white" }, " iOS 16 Slider demo ", -1);
        ...
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            ...
            color: hovered || panning ? 'rgb(255,255,255)' : 'rgb(120,113,108)',
                    ...
                    createBaseVNode("p", null, "progress: " + toDisplayString($setup.progress), 1),
                    createBaseVNode("p", null, "rounded: " + toDisplayString($setup.roundedProgress), 1)
                  ]),
                  _: 1
                })
              ])
