import { as as _export_sfc, aw as openBlock, aH as createElementBlock, aG as createBaseVNode, aD as defineComponent, aS as onMounted, aX as createStaticVNode, bt as useCssModule, aB as normalizeClass, at as ref, ax as createBlock, ay as withCtx, aM as createTextVNode, aL as toDisplayString, aC as resolveDynamicComponent, aE as resolveComponent, aF as createVNode } from "./vendor-DNJAtGl5.js";
import { s as setInterval } from "./interval-DebYQn3g.js";
const _sfc_main$5 = {};
const _hoisted_1$4 = { class: "text-5xl" };
function _sfc_render$5(_ctx, _cache) {
  return openBlock(), createElementBlock("h2", _hoisted_1$4, _cache[0] || (_cache[0] = [
    createBaseVNode(
      "span",
      { class: "word" },
      "Explore ",
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("h1", _hoisted_1$3, _cache[0] || (_cache[0] = [
