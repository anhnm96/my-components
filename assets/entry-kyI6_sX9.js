const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/default-DSQLvSqP.js","assets/components-DNY9wtJ2.js","assets/vendor-C4D-UogB.js","assets/error-404-C77J6pfh.js","assets/error-dev-3iVmidSL.js"])))=>i.map(i=>d[i]);
import { bD as useNuxtApp, bE as hasInjectionContext, aY as inject, bF as hasProtocol, bG as isScriptProtocol, bH as withQuery, bI as toRef, bJ as createError$1, bK as nuxtDefaultErrorValue, bL as $fetch$1, b7 as getCurrentInstance, b6 as reactive, bM as parse, bN as defineNuxtPlugin, bO as executeAsync, bh as shallowRef, bP as destr, at as ref, bQ as shallowReactive, bR as withoutBase, bS as useRuntimeConfig, av as computed, aD as defineComponent, bT as h, bU as isReadonly, bV as isEqual, bW as stringifyParsedURL, bX as stringifyQuery, bY as parseQuery, bZ as joinURL, b_ as LazyIcon, b$ as LazyIconCSS, c0 as createConsola, c1 as devRootDir, _ as __vitePreload, c2 as unhead_4FH17JNVCL, as as _export_sfc, aw as openBlock, ax as createBlock, ba as normalizeProps, bb as guardReactiveProps, R as defineAsyncComponent, aZ as provide, c3 as onErrorCaptured, ay as withCtx, aH as createElementBlock, aC as resolveDynamicComponent, c4 as Suspense, c5 as onServerPrefetch, c6 as componentIslands, c7 as createSSRApp, bz as createApp, c8 as createNuxtApp, c9 as applyPlugins, ca as vueAppRootContainer, b1 as nextTick } from "./vendor-C4D-UogB.js";
import { b as baseURL } from "./paths-Dju_msDK.js";
...
const layouts = {
  default: () => __vitePreload(() => import("./default-DSQLvSqP.js"), true ? __vite__mapDeps([0,1,2]) : void 0)
};
...
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const _Error404 = defineAsyncComponent(() => __vitePreload(() => import("./error-404-C77J6pfh.js"), true ? __vite__mapDeps([3,1,2]) : void 0));
    const _Error = defineAsyncComponent(() => __vitePreload(() => import("./error-dev-3iVmidSL.js"), true ? __vite__mapDeps([4,2]) : void 0));
