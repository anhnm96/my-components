import { aD as defineComponent, at as ref, b6 as reactive, bk as useId, aZ as provide, bl as useLocalStorage, aS as onMounted, as as _export_sfc, aw as openBlock, ax as createBlock, ay as withCtx, az as renderSlot, aC as resolveDynamicComponent, aY as inject, aT as watch, aA as normalizeStyle, bm as useTemplateRef, av as computed, aG as createBaseVNode, aQ as mergeProps, bn as Teleport, aE as resolveComponent, aF as createVNode, aM as createTextVNode } from "./vendor-DNJAtGl5.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { addItem, state, directionValue, panelRef, panelId };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(resolveDynamicComponent($props.as), {
    ...
    _: 3
    /* FORWARDED */
  }, 8, ["id", "data-panel-item-id", "data-panel-item-min-size", "data-panel-item-max-size", "style"]);
}
