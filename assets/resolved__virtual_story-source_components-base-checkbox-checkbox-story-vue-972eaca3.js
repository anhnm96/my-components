const resolved__virtual_storySource_componentsBaseCheckboxCheckboxStoryVue = `<script lang="ts" setup>
...
`;
export {
  resolved__virtual_storySource_componentsBaseCheckboxCheckboxStoryVue as default
};
