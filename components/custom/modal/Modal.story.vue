  ...
  <div class="flex items-center justify-center">
    <div class="rounded-lg bg-white px-6 py-6 shadow-md">
      ...
      <div class="mt-6">
        ...
        <Modal v-model="open" aria-labelledby="dialog-title" :persistent="true">
          <div class="w-full max-w-lg rounded-lg bg-white px-6 py-6 shadow-2xl">
            <h2
              id="dialog-title"
              class="border-b-2 border-gray-200 pb-4 text-2xl font-semibold leading-tight text-gray-900"
            >
            ...
            <div class="mt-6">
              ...
              <button
                class="focus:shadow-outline ml-4 rounded border bg-white px-4 py-2 font-semibold text-gray-800 hover:bg-gray-100 focus:outline-none"
                @click="open = false"
              >
                Cancel
              </button>
